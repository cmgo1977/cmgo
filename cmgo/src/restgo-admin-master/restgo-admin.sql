...
INSERT INTO `resource` VALUES (1,'^\\s+$','用户管理','mod',0,1),(2,'/user/list.shtml','用户管理页面','page',1,1),(3,'/user/search','搜索用户','api',1,1),(4,'^\\s+$','系统设置','mod',0,1),(5,'/setting/role.shtml','角色设置','page',4,1),(6,'/setting/site.shtml','参数设置','page',4,1);
